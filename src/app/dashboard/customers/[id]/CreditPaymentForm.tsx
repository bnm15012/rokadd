...
import { recordCreditPayment } from "@/actions/customers";
...
export function CreditPaymentForm({ creditSaleId, balancePaise }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl mx-4">
            ...
            <form action={formAction} className="space-y-4">
              <input type="hidden" name="creditSaleId" value={creditSaleId} />
