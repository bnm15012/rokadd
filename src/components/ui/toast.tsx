...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn(
      "absolute right-1 top-1 rounded-md p-1 text-slate-400 opacity-0 transition-opacity",
      "hover:text-slate-900 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-blue-500",
